...
$Exchange2010.location           = New-Object System.Drawing.Point(295,44)
...
$Exchange2013_2016.location      = New-Object System.Drawing.Point(296,69)
...
$Office365.width                 = 95
$Office365.height                = 20
$Office365.location              = New-Object System.Drawing.Point(296,95)
...
$PermissionsonPremisandO365.controls.AddRange(@($ServiceAccountName,$GO,$Cancel,$ExchangeServerName,$Exchange2010,$Exchange2013_2016,$ExchangeServName,$UerName_TenentAdmin,$LogonMethod,$Office365,$ServiceAccount,$SyncAccountName,$AddPermissions,$PermissionsChoice,$RemovePermissions))

$Cancel.Add_Click({Exit-PSSession})
$GO.Add_Click({  })



#Write your logic code here
function Exchange2010 {
    
}
$Cred = Get-Credential
$Session = New-PSSession -ConfigurationName Microsoft.Exchange -ConnectionUri http://$ExchangeServName/PowerShell/ -Authentication Kerberos -Credential $Cred
Import-PSSession $Session -DisableNameChecking
Set-ADServerSettings -ViewEntireForest $true

$AddPermissions = Get-Mailbox -Resultsize Unlimited | Add-MailboxPermission -User $ServiceAccount -AccessRights 'FullAccess' -InheritanceType all -AutoMapping:$false -Confirm:$false
