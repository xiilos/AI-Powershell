...
#License Varify
$Calendars = if ($Today -ge $LicenseKeyAExpiry -and $LicenseKeyAExpiry -notlike "") {
...
Contacts Sync=  $LicenseKeyCExpiry
Relationship Group Manager= $LicenseKeyEExpiry
GAL Sync=   $LicenseKeyGExpiry
Mail Confidentiality=   $LicenseKeyMExpiry
Email Notifications=    $LicenseKeyNExpiry
Notes Sync= $LicenseKeyOExpiry
Posts Sync= $LicenseKeyPExpiry
Tasks Sync= $LicenseKeyTExpiry
