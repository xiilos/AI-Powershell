...
$Dynamic_txt.location = New-Object System.Drawing.Point(15, 265)
...
$Add2Exchange_Permissions_Menu.controls.AddRange(@($DIB_Logo, $ExchangeServerName_Label, $ExServ_Name_txt, $Create_Task, $O365_GA_Label, $GB_Admin_txt, $Sync_Account_Label, $Sync_Accoun_txt, 
        $O365_Check, $On_Premise_Check, $All_Perm_Check, $Dist_List_Check, $Dynamic_Check, $Dist_List_Label, $Dist_Name_txt, $Dynamic_Label, $Dynamic_txt, $Static_Label, $Static_txt, 
        $Permissions_Options, $Logon_Choice, $Exchange_Admin_Password_Update, $Global_Admin_Password_Update, $UpdateCreds, $EX_Pass, $GB_Admin_Pass))
...
$Create_Task.Add_Click( {
        ...
        if ($O365_Check.Checked -and $Dist_List_Check.checked) {
            ...
            Register-ScheduledTask -Action $Action -RunLevel Highest -Trigger $Trigger -TaskName "A2E Permissions to Dist. List O365" -Description "Adds Add2Exchange Permissions Automatically to a Distribution List"
            Write-Host "Done" 
        }
        ...
        # Option 4: Office 365 & On-Premis-Add Permissions to All


        if ($O365_Check.Checked -and $On_Premise_Check.checked -and $All_Perm_Check.checked) {
            Write-Host "You chose to Add Permissions to all users on Premis & Office 365"
        ...
        if ($O365_Check.Checked -and $On_Premise_Check.checked -and $Dist_List_Check.checked) {
