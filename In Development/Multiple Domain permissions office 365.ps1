...
$DLName = "distributionlist@domain.com"  # The name of the distribution list
...
# Loop through each domain and grant full access to the user for each user in the distribution list
foreach ($Domain in $Domains) {
    ...
    foreach ($User in $Users) {
        ...
        Write-Host "Granted full access to $UserEmail for $UserToAdd in $Domain"
    }
}
